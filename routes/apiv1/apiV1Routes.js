...
router.post("/login", adminControllers.userValidationLogin, adminControllers.postUserLogin);

// USER REGISTER ROUTES
router.get("/signup", adminControllers.getUserSignUp);
router.post("/signup", adminControllers.userValidationSignUp, adminControllers.postUserSignUp);
